...
//                String pastaUploadImagem = "C:\\Users\\Amanda Piva\\TCC\\MAOSESTENDIDAS\\src\\main\\resources\\static\\images\\imgUploads";
...
//    }
    ...
    @Override
    public Pessoa updateSenhaManual(PessoaDTO dto, String idPessoa) {
        Optional<Pessoa> pessoa = pessoaRepository.findById(idPessoa);
        if(pessoa.isEmpty()) throw new RuntimeException("Pessoa não encontrada pelo email informado");
